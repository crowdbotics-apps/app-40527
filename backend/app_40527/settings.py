"""
Django settings for app_40527 project.
...
WSGI_APPLICATION = 'app_40527.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "app_40527 API",
    "DESCRIPTION": "API documentation for app_40527 App",
    "VERSION": "v1",
}
